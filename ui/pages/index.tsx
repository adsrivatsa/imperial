...
import catanMap from "../public/assets/catan_map.png";
                ...
                <div className="flex flex-col md:flex-row max-h-[90vh] overflow-auto">
                    ...
                    <div className="basis-full md:basis-1/6 flex flex-col md:h-[60vh]">
                        ...
                        <div className="basis-auto w-3/4 m-auto md:w-full">
                            <Link href="/sp">
                                <button className="w-[100%] p-4 text-3xl my-1 text-white bg-[#F06701] hover:bg-[#d95c01] backdrop-blur rounded-lg small-caps transition-colors">
                                    Single Player
                                </button>
                            </Link>
                            <Link href="/lobby">
